...
Original file is located at
    https://colab.research.google.com/drive/190KBq-kWNy-goPo7lc_oYyiNjkVY2JMZ
"""
...
latent_dim = 2 # Define latent_dim here
...
fashion_mnist = np.expand_dims (fashion_mnist, -1).astype("float32") / 255.0
